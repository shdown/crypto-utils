...
template<> struct Field_traits<4>
{
 ...
 {
  return teki_mul_q_4(const_cast<uint64_t*>(a0), a1, a2);
 }
 static inline uint64_t div_leaky_q(const uint64_t* a0, uint64_t a1, uint64_t* a2)
 {
  return teki_div_leaky_q_4(const_cast<uint64_t*>(a0), a1, a2);
 }
 ...
 {
  return teki_shr_4(const_cast<uint64_t*>(a0), a1, a2);
 }
 static inline void shl(const uint64_t* a0, uint64_t a1, uint64_t* a2)
 {
  return teki_shl_4(const_cast<uint64_t*>(a0), a1, a2);
 }
